...
module.exports = {
  ...
  execute(message) {
    const list = [
      ...
      'Gestern sagte mir eine Affäre, sie würde mich auch noch lieben, sollte ich mal kein Geld mehr haben. Was haben wir herzlich gelacht. Ich und kein Geld mehr haben... - AUS DEM WEG, GERINGVERDIENER!',
      ...
      'So kurz vor Weihnachten brauche auch ich mal eure Hilfe. Denkt ihr, mein alter iPhone ist okay zum Schrottwicheln oder sollte ich doch besser schnell noch ein Android-Handy kaufen gehen?  - AUS DEM WEG, GERINGVERDIENER!',
      ...
      'Den armen Menschen, die am Straßenrand mit Gepäck und Daumen hoch stehen, und mir und meinem Porsche ein Like geben, gebe ich immer eines zurück - AUS DEM WEG, GERINGVERDIENER!',
